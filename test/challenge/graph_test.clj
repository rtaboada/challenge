...
(defn closeness-value-ring-graph
  "Formula that calculates the closeness value in a ring graph of n vertices.
   ...
   The sum of a sequence 1..n is equal n * (n+1) / 2, but we have two sequences 
   and the formula simplifies to: n * (n+1)"
  [n]
...
;; Checks that in the extreme of the graph the distance vector is 
